...
Includes the Newsletter model representing publications associated with publishers and authors.
"""
...
class Newsletter(models.Model):
    ...
    publisher = models.ForeignKey(
        "articles.Publisher", on_delete=models.CASCADE, related_name="newsletters"
    )
